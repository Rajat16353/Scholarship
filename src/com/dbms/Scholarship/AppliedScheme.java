...
public class AppliedScheme extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Check Notifications");
        ...
        jButton2.setText("Apply for another Scholarship");
...
//for using label as button
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        ...
        try
        {
            ...
            {
               pf=new Profile(jLabel18.getText());
               pf.setVisible(true);
                setVisible(false);
            }
            else
    ...
    private void jLabel19MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel19MouseClicked
        ...
        try
        {
            ...
            if(rs.getString(3).equalsIgnoreCase("pending"))
            {
                pf=new Profile(jLabel19.getText());
                pf.setVisible(true);
                setVisible(false);
            }
            else
...
//to open notificartions window
    private void application_info()
    {
        ...
        try
        {
            ...
            jLabel25.setText(" "+rs.getString("benefits"));
            if(rs.next())
            {
                ...
                jLabel26.setText(" "+rs.getString("benefits"));
            }
        }
        catch(SQLException ex)
        {
